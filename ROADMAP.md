...
- **Límites de tiempo por app** (UsageStats): al superar X min → fricción reforzada.
- **Sesiones programadas** (franjas horarias) que ocultan/bloquean apps distractoras.
- **Nudge a escala de grises** (deep-link / atajo, opcionalmente programado).
- Riesgo: monitoreo en runtime → cuidar batería y política de Play.
